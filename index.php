...
//seleccion de servicios de servicios 
$sentencia=$conexion->prepare("SELECT * FROM `tbl_servicios`");
$sentencia->execute();
$lista_servicios=$sentencia->fetchAll(PDO::FETCH_ASSOC);

//seleccion de servicios de portafolio
...
<html lang="es">
  ...
  <body id="page-top">
    ...
    <section class="page-section bg-light" id="portfolio">
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            ...
            <div class="portfolio-item">
              <a
                ...
                href="#portfolioModal<?php echo $registros["ID"]; ?>"
              >
      ...
      id="portfolioModal<?php echo $registros["ID"]; ?>""
      tabindex="-1"
      role="dialog"
      aria-hidden="true"
    >
          ...
          <div class="col-lg-4">
            <div class="team-member">
              <img
                ...
                src="assets/img/team/<?php echo $registros["imagen"]; ?>"
                alt="..."
              />
              ...
              <a
                ...
                href="<?php echo $registros["twitter"]; ?>"
                aria-label="Parveen Anand Twitter Profile"
                ><i class="fab fa-twitter"></i
              ></a>
              <a
                class="btn btn-dark btn-social mx-2"
                href="<?php echo $registros["facebook"]; ?>"
                aria-label="Parveen Anand Facebook Profile"
                ><i class="fab fa-facebook-f"></i
              ></a>
              <a
                class="btn btn-dark btn-social mx-2"
                href="<?php echo $registros["linkedin"]; ?>"
